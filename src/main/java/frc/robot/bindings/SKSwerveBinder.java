...
public class SKSwerveBinder implements CommandBinder{
    ...
    public void bindButtons()
    {
        ...
        resetButton.onTrue(new InstantCommand(() -> {drive.setCurrentRotationAsForward();} ));

        // Example of an automated driving command bound to a button:
        ...
        // Default to field-centric drive when not holding the robot centric button
