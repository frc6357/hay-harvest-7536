...
public class SKVision extends SubsystemBase {
    ...
    /* Example:
    public static final Limelight rightLL = new Limelight(VisionConfig.RIGHT_CONFIG); // limelight-front
    */
    
    // TODO: Add limelight declarations here- the rest should handle itself as long as you add them to the arrays below
    
    // Array of all limelights
    public static final Limelight[] allLimelights = {}; 
    // Limelights for pose estimation; order them from most used with best view to least used with worst view
    public static final Limelight[] poseLimelights = {}; 
    ...
    public Limelight getBestLimelight() {
        if(poseLimelights.length == 0) {
            return null; // No limelights configured for pose estimation
        }
