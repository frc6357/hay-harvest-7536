...
public class SKSwerve extends SubsystemBase {
    ...
    /** NOTE: If this has an error, just build the project and it should go away. */
    ...
    */
    ...
    public void setCurrentRotationAsForward() {
        Rotation2d currentRotation = getRobotRotation();
        drivetrain.setOperatorPerspectiveForward(Field.isBlue() ? currentRotation : currentRotation.plus(Rotation2d.k180deg));
    }
